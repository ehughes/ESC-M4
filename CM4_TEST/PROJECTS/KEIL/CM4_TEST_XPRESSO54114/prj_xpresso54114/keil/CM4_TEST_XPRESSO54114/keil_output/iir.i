...
#line 110 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\CMSIS_DSP_4_5\\inc\\core_cm4.h"



 
#line 125 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\CMSIS_DSP_4_5\\inc\\core_cm4.h"

#line 186 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\CMSIS_DSP_4_5\\inc\\core_cm4.h"
...
#line 188 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\CMSIS_DSP_4_5\\inc\\core_cm4.h"
...
#line 189 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\CMSIS_DSP_4_5\\inc\\core_cm4.h"
...
#line 190 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\CMSIS_DSP_4_5\\inc\\core_cm4.h"
#line 1 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\CMSIS_DSP_4_5\\inc\\core_cmSimd.h"
...
#line 122 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\CMSIS_DSP_4_5\\inc\\core_cmSimd.h"
...
#line 689 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\CMSIS_DSP_4_5\\inc\\core_cmSimd.h"
...
#line 191 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\CMSIS_DSP_4_5\\inc\\core_cm4.h"
...
#line 4 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\TEST\\IIR.c"
#line 5 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\TEST\\IIR.c"
 ...
 void Compute_f32_IIR(f32_IIR *MyIIR,float Input,float *Output)
{
    ...
    acc = Input * MyIIR->Coef.b[0];
     
    acc +=  MyIIR->State.Xn1 * MyIIR->Coef.b[1];
     
    acc +=  MyIIR->State.Xn2 * MyIIR->Coef.b[2];
     
    acc += MyIIR->State.Yn1 * MyIIR->Coef.a[0];
     
    acc += MyIIR->State.Yn2 * MyIIR->Coef.a[1];
...
#line 108 "..\\..\\..\\..\\..\\..\\COMMON\\SRC\\TEST\\IIR.c"
                               ...
                               )
{
    ...
    switch(FilterType)
        {
            ...
            case            7:
                coef[3] =    A*( (A+1.0) - (A-1.0)*cos(w0) + 2.0*sqrt(A)*alpha );
                coef[4] =  2.0*A*( (A-1.0) - (A+1.0)*cos(w0)                   );
                coef[5] =    A*( (A+1.0) - (A-1.0)*cos(w0) - 2.0*sqrt(A)*alpha );
                coef[0] =        (A+1.0) + (A-1.0)*cos(w0) + 2.0*sqrt(A)*alpha;
                coef[1] =   -2.0*( (A-1.0) + (A+1.0)*cos(w0)                   );
                coef[2] =        (A+1.0) + (A-1.0)*cos(w0) - 2.0*sqrt(A)*alpha;
                break;

            case           8:
                coef[3] =    A*( (A+1) + (A-1)*cos(w0) + 2*sqrt(A)*alpha );
                coef[4] = -2*A*( (A-1) + (A+1)*cos(w0)                   );
                coef[5] =    A*( (A+1) + (A-1)*cos(w0) - 2*sqrt(A)*alpha );
                coef[0] =        (A+1) - (A-1)*cos(w0) + 2*sqrt(A)*alpha;
                coef[1] =    2*( (A-1) - (A+1)*cos(w0)                   );
                coef[2] =        (A+1) - (A-1)*cos(w0) - 2*sqrt(A)*alpha;
                break;
        }
    ...
    coef[3] = coef[3]/coef[0];
    coef[4] = coef[4]/coef[0];
    coef[5] = coef[5]/coef[0];
    ...
    while(GetPeak(&coef[0],6) > 1.0)
        {
            C->PostShift++;
            coef[3] = coef[3]/(float)(1<<C->PostShift);
            coef[4] = coef[4]/(float)(1<<C->PostShift);
            coef[5] = coef[5]/(float)(1<<C->PostShift);
            coef[1] = coef[1]/(float)(1<<C->PostShift);
            coef[2] = coef[2]/(float)(1<<C->PostShift);
            coef[0] = coef[0]/(float)(1<<C->PostShift);
        }

    C->a[0] = (q31_t)(0x7FFFFFFF * coef[1]); 
    C->a[1] = (q31_t)(0x7FFFFFFF * coef[2]); 
    C->b[0] = (q31_t)(0x7FFFFFFF * coef[3]);
    C->b[1] = (q31_t)(0x7FFFFFFF * coef[4]);
    C->b[2] = (q31_t)(0x7FFFFFFF * coef[5]);
    return;
}
