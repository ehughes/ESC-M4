...
const PLL_SETUP_T pll_setup_48KHz = {
	0x00047C80,							// PLL control register
	0x0000042D,                         // PLL NDEC register
	0x000000C2,                         // PLL PDEC register
	{0x000634D3, 0x00000000},           // PLL SSCTL registers
	24576000,                           // Acutal PLL rate
