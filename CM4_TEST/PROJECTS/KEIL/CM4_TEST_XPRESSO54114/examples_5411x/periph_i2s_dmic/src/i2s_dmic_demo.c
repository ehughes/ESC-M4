/*
 * @brief Peripheral I2S DMIC example.
 *
 * @note
...
void i2s_ds(I2S_STATISTICS_T* s)
{
...
void dmic_ds(DMIC_STATISTICS_T* s)
{
	printf("DMIC statistics\n");
...
//------------------------------------------------------------------------------
	...
	dmic_pinmux_init();															//	initialize DMIC pins
	dmic_cfg();																	//	configure DMIC
	dmic_start();																//	start DMIC
...
//------------------------------------------------------------------------------
	...
	wm8904_set_sample_rate(MCLK_FS_512X, 48000, 16);
