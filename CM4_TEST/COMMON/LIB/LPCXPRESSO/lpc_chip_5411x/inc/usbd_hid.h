...
#define HID_USAGE_CONSUMER_RANDOM_PLAY          0xB9
#define HID_USAGE_CONSUMER_REPEAT               0xBC
#define HID_USAGE_CONSUMER_TRACKING_NORMAL      0xBE
#define HID_USAGE_CONSUMER_TRACKING_INCREMENT   0xCA
#define HID_USAGE_CONSUMER_TRACKIN_DECREMENT    0xCB
