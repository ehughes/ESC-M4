...
#ifndef __I2CM_5411X_H_
#define __I2CM_5411X_H_
...
/** @defgroup I2CM_5411X CHIP: LPC5411X I2C master-only driver
 * @ingroup I2C_5411X
...
/** I2CM_5411X_STATUS_TYPES I2C master transfer status types
 */
...
#define I2CM_STATUS_NAK_DAT           0x04		/*!< No acknowledgement received from slave during data phase. */
 ...
 *          according to the bus mode.<br>
 *          This API will also support non-standard bus speeds provided
 *          it is an integer multiple of (18, 16, 14, 12, 10, 8, 6, 4).<br>
