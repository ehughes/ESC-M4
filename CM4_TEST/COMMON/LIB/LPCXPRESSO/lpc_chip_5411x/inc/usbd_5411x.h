/*
 * @brief LPC5411x USB device register block
 *
 * @note
...
#ifndef __USBD_5411X_H_
#define __USBD_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup USBD_5411X CHIP: LPC5411x USB Device driver
