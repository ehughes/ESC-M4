/*
 * @brief LPC5411X Multi-Rate Timer (MRT) registers and driver functions
 *
 * @note
...
#ifndef __MRT_5411X_H_
#define __MRT_5411X_H_

#ifdef __cplusplus
extern "C" {
#endif

/** @defgroup MRT_5411X CHIP: LPC5411X Multi-Rate Timer driver
 * @ingroup CHIP_5411X_DRIVERS
 * @{
 */

/**
 * @brief LPC5411X MRT chip configuration
 */
...
#define MRT_INTVAL_IVALUE        (0xFFFFFF)		/* Maximum interval load value and mask */
