...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_offset_q7.c"
  ...
  uint32_t blockSize)
{
  ...
  offset_packed = ( (((int32_t)(offset) << 0) & (int32_t)0x000000FF) | (((int32_t)(offset) << 8) & (int32_t)0x0000FF00) | (((int32_t)(offset) << 16) & (int32_t)0x00FF0000) | (((int32_t)(offset) << 24) & (int32_t)0xFF000000) );
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pDst))++ = __qadd8(*(*(int32_t __packed * *) & (pSrc))++, offset_packed);
...
#line 130 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_offset_q7.c"
