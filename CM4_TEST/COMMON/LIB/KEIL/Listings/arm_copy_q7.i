#line 1 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_copy_q7.c"
...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_copy_q7.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pDst))++ = *(*(int32_t __packed * *) & (pSrc))++;
...
#line 100 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_copy_q7.c"
