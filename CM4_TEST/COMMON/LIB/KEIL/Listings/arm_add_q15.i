#line 1 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_add_q15.c"
...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_add_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pDst))++ = __qadd16(inA1, inB1);
    *(*(int32_t __packed * *) & (pDst))++ = __qadd16(inA2, inB2);
...
#line 134 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_add_q15.c"
