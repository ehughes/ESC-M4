...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_negate_q7.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    input = *(*(int32_t __packed * *) & (pSrc))++;

     
    *(*(int32_t __packed * *) & (pDst))++ = __qsub8(zero, input);
...
#line 110 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_negate_q7.c"
