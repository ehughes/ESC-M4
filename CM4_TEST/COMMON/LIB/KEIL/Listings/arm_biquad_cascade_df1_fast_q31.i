...
#line 43 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_biquad_cascade_df1_fast_q31.c"
  ...
  uint32_t blockSize)
{
  ...
  do
  {
    ...
    while(sample > 0u)
    {
      ...
      acc = (q31_t) (((q63_t) b1 * Xn1 + 0x80000000LL ) >> 32);
       
       
      acc = (q31_t) (((((q63_t) acc) << 32) + ((q63_t) b0 * Xn) + 0x80000000LL ) >> 32);
      ...
      *pOut = Yn2;
      ...
      acc = (q31_t) (((q63_t) b0 * Xn2 + 0x80000000LL ) >> 32);
       
       
      acc = (q31_t) (((((q63_t) acc) << 32) + ((q63_t) b1 * Xn) + 0x80000000LL ) >> 32);
       
       
      acc = (q31_t) (((((q63_t) acc) << 32) + ((q63_t) b2 * Xn1) + 0x80000000LL ) >> 32);
       
       
      acc = (q31_t) (((((q63_t) acc) << 32) + ((q63_t) a1 * Yn2) + 0x80000000LL ) >> 32);
       
       
      acc = (q31_t) (((((q63_t) acc) << 32) + ((q63_t) a2 * Yn1) + 0x80000000LL ) >> 32);
      ...
      *(pOut + 1u) = Yn1;
      ...
      acc = (q31_t) (((q63_t) b0 * Xn1 + 0x80000000LL ) >> 32);
       
       
      acc = (q31_t) (((((q63_t) acc) << 32) + ((q63_t) b1 * Xn2) + 0x80000000LL ) >> 32);
       
       
      acc = (q31_t) (((((q63_t) acc) << 32) + ((q63_t) b2 * Xn) + 0x80000000LL ) >> 32);
