...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_q7_to_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    out2 = ( ((((uint32_t)(in1)) ) & 0xFFFF0000UL) | ((((uint32_t)(in2)) >> (16)) & 0x0000FFFFUL) );
    out1 = ( ((((uint32_t)(in2)) ) & 0x0000FFFFUL) | ((((uint32_t)(in1)) << (16)) & 0xFFFF0000UL) );

#line 122 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_q7_to_q15.c"

    *(*(int32_t __packed * *) & (pDst))++ = out1;
    *(*(int32_t __packed * *) & (pDst))++ = out2;
...
#line 142 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_q7_to_q15.c"
