...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_q15.c"
  ...
  q15_t * pDst)
{
  ...
  uint32_t blockSize1, blockSize2, blockSize3, j, k, count, blkCnt;      
  ...
  while(blockSize1 > 0u)
  {
    ...
    while(k > 0u)
    {
      ...
      sum = __smlaldx(*(*(int32_t __packed * *) & (px))++, *(*(int32_t __packed * *) & (py))--, sum);
  ...
  if(srcBLen >= 4u)
  {
    ...
    while(blkCnt > 0u)
    {
      ...
      x0 = *(*(int32_t __packed * *) & (px));
       
      x1 = (*(int32_t __packed *) (px+1));
	  px+= 2u;
      ...
      do
      {
        ...
        x2 = *(*(int32_t __packed * *) & (px));

         
        x3 = (*(int32_t __packed *) (px+1));
        ...
        x0 = (*(int32_t __packed *) (px+2));

         
        x1 = (*(int32_t __packed *) (px+3));
		px += 4u;
      ...
      *(*(int32_t __packed * *) & (pOut))++ =
        ( ((((uint32_t)(__ssat((acc0 >> 15), 16))) ) & 0x0000FFFFUL) | ((((uint32_t)(__ssat((acc1 >> 15), 16))) << (16)) & 0xFFFF0000UL) );
      *(*(int32_t __packed * *) & (pOut))++ =
        ( ((((uint32_t)(__ssat((acc2 >> 15), 16))) ) & 0x0000FFFFUL) | ((((uint32_t)(__ssat((acc3 >> 15), 16))) << (16)) & 0xFFFF0000UL) );

#line 471 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_q15.c"
...
#line 729 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_q15.c"
