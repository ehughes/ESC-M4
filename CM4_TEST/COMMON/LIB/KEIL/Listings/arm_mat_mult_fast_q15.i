...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_fast_q15.c"
...
#line 114 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_fast_q15.c"

#line 125 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_fast_q15.c"
  {
...
#line 236 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_fast_q15.c"
    ...
    do
    {
      ...
      do
      {
        ...
        while(colCnt > 0u)
        {
          ...
          inA1 = *(*(int32_t __packed * *) & (pInA))++;
          inB1 = *(*(int32_t __packed * *) & (pInB))++;
          inA2 = *(*(int32_t __packed * *) & (pInA))++;
          inB2 = *(*(int32_t __packed * *) & (pInB))++;

          sum = __smlad(inA1, inB1, sum);
          sum = __smlad(inA2, inB2, sum);

#line 327 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_fast_q15.c"
