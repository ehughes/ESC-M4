...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_shift_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  if(sign == 0u)
  {
    ...
    while(blkCnt > 0u)
    {
      ...
      *(*(int32_t __packed * *) & (pDst))++ = ( ((((uint32_t)(__ssat((in1 << shiftBits), 16))) ) & 0x0000FFFFUL) | ((((uint32_t)(__ssat((in2 << shiftBits), 16))) << (16)) & 0xFFFF0000UL) );


#line 111 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_shift_q15.c"
...
#line 126 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_shift_q15.c"
  ...
  else
  {
    ...
    while(blkCnt > 0u)
    {
      ...
      *(*(int32_t __packed * *) & (pDst))++ = ( ((((uint32_t)((in1 >> -shiftBits))) ) & 0x0000FFFFUL) | ((((uint32_t)((in2 >> -shiftBits))) << (16)) & 0xFFFF0000UL) );


#line 168 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_shift_q15.c"
...
#line 183 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_shift_q15.c"
...
#line 243 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_shift_q15.c"
