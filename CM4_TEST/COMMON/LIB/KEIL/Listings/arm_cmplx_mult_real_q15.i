...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ComplexMathFunctions\\arm_cmplx_mult_real_q15.c"
  ...
  uint32_t numSamples)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    inA1 = *(*(int32_t __packed * *) & (pSrcCmplx))++;
     
    inB1 = *(*(int32_t __packed * *) & (pSrcReal))++;
     
    inA2 = *(*(int32_t __packed * *) & (pSrcCmplx))++;
...
#line 116 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ComplexMathFunctions\\arm_cmplx_mult_real_q15.c"
    ...
    *(*(int32_t __packed * *) & (pCmplxDst))++ = ( ((((uint32_t)(out1)) ) & 0x0000FFFFUL) | ((((uint32_t)(out2)) << (16)) & 0xFFFF0000UL) );
    *(*(int32_t __packed * *) & (pCmplxDst))++ = ( ((((uint32_t)(out3)) ) & 0x0000FFFFUL) | ((((uint32_t)(out4)) << (16)) & 0xFFFF0000UL) );
...
#line 146 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ComplexMathFunctions\\arm_cmplx_mult_real_q15.c"
...
#line 198 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ComplexMathFunctions\\arm_cmplx_mult_real_q15.c"
