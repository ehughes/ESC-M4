...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_q15.c"
...
{    
    ...
    for (i = n2; i > 0; i--)
    {
        coeff = (*(int32_t __packed *) (pC));
        pC += 2;

        T = (*(int32_t __packed *) (pSi));
        T = __shadd16(T, 0); 

        S = (*(int32_t __packed *) (pSl));
        S = __shadd16(S, 0); 

        R = __qsub16(T, S);

        (*(int32_t __packed *) (pSi)) = __shadd16(T, S);
        pSi += 2;
...
#line 196 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_q15.c"

        (*(int32_t __packed *) (pSl)) =
        (q31_t) ((out2) & 0xFFFF0000) | (out1 & 0x0000FFFF);
        pSl += 2;
    } 
    
#line 228 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_q15.c"
...
#line 302 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_q15.c"
...
#line 333 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_q15.c"
