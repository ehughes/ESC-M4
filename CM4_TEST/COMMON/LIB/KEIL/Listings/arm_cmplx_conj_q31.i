...
#line 41 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ComplexMathFunctions\\arm_cmplx_conj_q31.c"
  ...
  uint32_t numSamples)
{
  ...
  q31_t inR1, inR2, inR3, inR4;                   
  q31_t inI1, inI2, inI3, inI4;                   
...
#line 163 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ComplexMathFunctions\\arm_cmplx_conj_q31.c"
  ...
  while(blkCnt > 0u)
  {
    ...
    *pDst++ = *pSrc++;
    in = *pSrc++;
    *pDst++ = (in == (~0x7fffffff)) ? 2147483647 : -in;
