...
#line 43 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
  ...
  uint32_t twidCoefModifier)
{
  ...
  do
  {
    ...
    T = (*(int32_t __packed *) (pSi1));
    T = __shadd16(T, 0);
    T = __shadd16(T, 0);

     
    U = (*(int32_t __packed *) (pSi3));
    U = __shadd16(U, 0);
    U = __shadd16(U, 0);
    ...
    (*(int32_t __packed *) (pSi0)) = __shadd16(R, T);
    pSi0 += 2;
    ...
    C2 = (*(int32_t __packed *) (pCoef16 + (4u * ic)));
...
#line 275 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 312 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"

     
    C1 = (*(int32_t __packed *) (pCoef16 + (2u * ic)));
...
#line 332 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"

     
    (*(int32_t __packed *) (pSi2)) =
      ((out2) & 0xFFFF0000) | ((out1) & 0x0000FFFF);
    pSi2 += 2;


     
    C3 = (*(int32_t __packed *) (pCoef16 + (6u * ic)));
...
#line 358 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"

     
    (*(int32_t __packed *) (pSi3)) =
      ((out2) & 0xFFFF0000) | (out1 & 0x0000FFFF);
    pSi3 += 2;
...
#line 456 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 503 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 523 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
  ...
  do
  {
    ...
    xaya = *(*(int32_t __packed * *) & (ptr1))++;

     
    xbyb = *(*(int32_t __packed * *) & (ptr1))++;

     
    xcyc = *(*(int32_t __packed * *) & (ptr1))++;

     
    xdyd = *(*(int32_t __packed * *) & (ptr1))++;
    ...
    *(*(int32_t __packed * *) & (ptr1))++ = __shadd16(R, T);
    ...
    *(*(int32_t __packed * *) & (ptr1))++ = __shsub16(R, T);
    ...
    *(*(int32_t __packed * *) & (ptr1))++ = __shsax(S, U);


     
     
    *(*(int32_t __packed * *) & (ptr1))++ = __shasx(S, U);

#line 615 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 1027 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 1190 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 1227 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 1247 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 1273 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 1371 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 1418 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 1438 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 1530 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
...
#line 1923 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix4_q15.c"
