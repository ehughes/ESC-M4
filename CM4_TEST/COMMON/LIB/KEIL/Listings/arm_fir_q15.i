...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pStateCurnt))++ = *(*(int32_t __packed * *) & (pSrc))++;
    *(*(int32_t __packed * *) & (pStateCurnt))++ = *(*(int32_t __packed * *) & (pSrc))++;
    ...
    x0 = (*(int32_t __packed *) (px1));

     
    x1 = (*(int32_t __packed *) (px1 + 1u));
    ...
    while(tapCnt > 0u)
    {
      ...
      x2 = (*(int32_t __packed *) (px1));

       
      x3 = (*(int32_t __packed *) (px1 + 1u));
      ...
      x0 = (*(int32_t __packed *) (px1 + 2u));

       
      x1 = (*(int32_t __packed *) (px1 + 3u));
...
#line 241 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_q15.c"
  ...
  while(tapCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pStateCurnt))++ = *(*(int32_t __packed * *) & (pState))++;
    *(*(int32_t __packed * *) & (pStateCurnt))++ = *(*(int32_t __packed * *) & (pState))++;
...
#line 597 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_q15.c"

#line 685 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_q15.c"
