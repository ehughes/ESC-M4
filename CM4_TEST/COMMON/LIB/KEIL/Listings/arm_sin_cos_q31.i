...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ControllerFunctions\\arm_sin_cos_q31.c"
...
#line 43 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ControllerFunctions\\arm_sin_cos_q31.c"
  ...
  q31_t * pCosVal)
{
  ...
  indexS = (uint32_t)theta >> (32 - 9);
  indexC = (indexS + 128) & 0x1ff;

   
  fract = (theta - (indexS << (32 - 9))) << 8;
