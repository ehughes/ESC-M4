...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_q15.c"
...
arm_status arm_mat_mult_q15(
  ...
  const arm_matrix_instance_q15 * pSrcB,
  arm_matrix_instance_q15 * pDst,
  q15_t * pState __attribute__((unused)))
{
  q63_t sum;                                      
  ...
  uint16_t col, i = 0u, row = numRowsB, colCnt;   
  arm_status status;                              
...
#line 113 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_q15.c"

#line 124 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_q15.c"
  {
...
#line 242 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_q15.c"
    ...
    do
    {
      ...
      do
      {
        ...
        while(colCnt > 0u)
        {
          ...
          pSourceA1 = *(*(int32_t __packed * *) & (pInA))++;
          pSourceB1 = *(*(int32_t __packed * *) & (pInB))++;

          pSourceA2 = *(*(int32_t __packed * *) & (pInA))++;
          pSourceB2 = *(*(int32_t __packed * *) & (pInB))++;

           
          sum = __smlald(pSourceA1, pSourceB1, sum);
          sum = __smlald(pSourceA2, pSourceB2, sum);

#line 337 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_q15.c"
...
#line 459 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_mult_q15.c"
