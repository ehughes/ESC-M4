...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_mult_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    inA1 = *(*(int32_t __packed * *) & (pSrcA))++;
     
    inB1 = *(*(int32_t __packed * *) & (pSrcB))++;
     
    inA2 = *(*(int32_t __packed * *) & (pSrcA))++;
     
    inB2 = *(*(int32_t __packed * *) & (pSrcB))++;
    ...
    *(*(int32_t __packed * *) & (pDst))++ = ( ((((uint32_t)(out2)) ) & 0x0000FFFFUL) | ((((uint32_t)(out1)) << (16)) & 0xFFFF0000UL) );
    *(*(int32_t __packed * *) & (pDst))++ = ( ((((uint32_t)(out4)) ) & 0x0000FFFFUL) | ((((uint32_t)(out3)) << (16)) & 0xFFFF0000UL) );

#line 122 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_mult_q15.c"
...
#line 139 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_mult_q15.c"
