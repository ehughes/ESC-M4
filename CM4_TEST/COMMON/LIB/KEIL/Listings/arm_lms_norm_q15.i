...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_lms_norm_q15.c"
  ...
  while(blkCnt > 0u)
  {
    ...
    *pStateCurnt++ = *pSrc;
    ...
    while(tapCnt > 0u)
    {
      ...
      acc = __smlald(*(*(int32_t __packed * *) & (px))++, (*(*(int32_t __packed * *) & (pb))++), acc);
      acc = __smlald(*(*(int32_t __packed * *) & (px))++, (*(*(int32_t __packed * *) & (pb))++), acc);

#line 163 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_lms_norm_q15.c"
    ...
    *pErr++ = e;
    ...
    postShift = arm_recip_q15((q15_t) energy + 0x5,
...
#line 291 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_lms_norm_q15.c"
...
#line 434 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_lms_norm_q15.c"
