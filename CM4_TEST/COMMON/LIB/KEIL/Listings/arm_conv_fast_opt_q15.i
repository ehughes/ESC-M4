...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_fast_opt_q15.c"
...
#line 226 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_fast_opt_q15.c"
...
#line 269 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_fast_opt_q15.c"
  ...
  while(blkCnt > 0)
  {
    ...
    x1 = *(*(int32_t __packed * *) & (pScr1))++;

     
    x2 = *(*(int32_t __packed * *) & (pScr1))++;
    ...
    while(tapCnt > 0u)
    {
      ...
      y1 = (*(int32_t __packed *) (pIn2));
      y2 = (*(int32_t __packed *) (pIn2 + 2u));
...
#line 425 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_fast_opt_q15.c"
...
#line 481 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_fast_opt_q15.c"
