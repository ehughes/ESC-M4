...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_partial_opt_q7.c"
  ...
  q15_t * pScratch2)
{
  ...
  else
  {
    ...
    while(blkCnt > 0)
    {
      ...
      *(*(int32_t __packed * *) & (pOut))++ = ( (((int32_t)(out0) << 0) & (int32_t)0x000000FF) | (((int32_t)(out1) << 8) & (int32_t)0x0000FF00) | (((int32_t)(out2) << 16) & (int32_t)0x00FF0000) | (((int32_t)(out3) << 24) & (int32_t)0xFF000000) );
...
#line 798 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_partial_opt_q7.c"
