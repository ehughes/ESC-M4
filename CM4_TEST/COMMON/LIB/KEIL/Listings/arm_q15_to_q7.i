...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_q15_to_q7.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    in1 = *(*(int32_t __packed * *) & (pIn))++;
    in2 = *(*(int32_t __packed * *) & (pIn))++;



    out1 = ( ((((uint32_t)(in2)) ) & 0xFFFF0000UL) | ((((uint32_t)(in1)) >> (16)) & 0x0000FFFFUL) );
    out2 = ( ((((uint32_t)(in2)) ) & 0x0000FFFFUL) | ((((uint32_t)(in1)) << (16)) & 0xFFFF0000UL) );

#line 108 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_q15_to_q7.c"
...
#line 139 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_q15_to_q7.c"
