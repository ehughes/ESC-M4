...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_offset_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  offset_packed = ( ((((uint32_t)(offset)) ) & 0x0000FFFFUL) | ((((uint32_t)(offset)) << (16)) & 0xFFFF0000UL) );
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pDst))++ = __qadd16(*(*(int32_t __packed * *) & (pSrc))++, offset_packed);
    *(*(int32_t __packed * *) & (pDst))++ = __qadd16(*(*(int32_t __packed * *) & (pSrc))++, offset_packed);
...
#line 131 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_offset_q15.c"
