...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_iir_lattice_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  q31_t fcurr, fnext, gcurr = 0, gnext;           
  q15_t gnext1, gnext2;                           
  uint32_t stgCnt;                                
  q63_t acc;                                      
    ...
    *px2++ = (q15_t) gnext;
    ...
    while(tapCnt > 0u)
    {
      ...
      *px2++ = (q15_t) gnext2;
      ...
      v = *(*(int32_t __packed * *) & (pv))++;

#line 193 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_iir_lattice_q15.c"
      ...
      gnext = ( ((((uint32_t)(gnext1)) ) & 0x0000FFFFUL) | ((((uint32_t)(gnext2)) << (16)) & 0xFFFF0000UL) );
...
#line 262 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_iir_lattice_q15.c"
...
#line 345 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_iir_lattice_q15.c"
...
#line 456 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_iir_lattice_q15.c"
