...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_sub_q15.c"
...
#line 92 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_sub_q15.c"

  {
    ...
    while(blkCnt > 0u)
    {
      ...
      *(*(int32_t __packed * *) & (pOut))++ = __qsub16(*(*(int32_t __packed * *) & (pInA))++, *(*(int32_t __packed * *) & (pInB))++);
      *(*(int32_t __packed * *) & (pOut))++ = __qsub16(*(*(int32_t __packed * *) & (pInA))++, *(*(int32_t __packed * *) & (pInB))++);
...
#line 149 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_sub_q15.c"
