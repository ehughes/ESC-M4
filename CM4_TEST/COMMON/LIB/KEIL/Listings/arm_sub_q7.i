...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_sub_q7.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pDst))++ = __qsub8(*(*(int32_t __packed * *) & (pSrcA))++, *(*(int32_t __packed * *) & (pSrcB))++);
...
#line 125 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_sub_q7.c"
