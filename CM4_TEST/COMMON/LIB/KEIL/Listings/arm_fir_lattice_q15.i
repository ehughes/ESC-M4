...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_lattice_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  q31_t fcurnt1, fnext1, gcurnt1 = 0, gnext1;     
  q31_t fcurnt2, fnext2, gnext2;                  
  q31_t fcurnt3, fnext3, gnext3;                  
  q31_t fcurnt4, fnext4, gnext4;                  
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pDst))++ = ( ((((uint32_t)(fcurnt1)) ) & 0x0000FFFFUL) | ((((uint32_t)(fcurnt2)) << (16)) & 0xFFFF0000UL) );
    *(*(int32_t __packed * *) & (pDst))++ = ( ((((uint32_t)(fcurnt3)) ) & 0x0000FFFFUL) | ((((uint32_t)(fcurnt4)) << (16)) & 0xFFFF0000UL) );

#line 374 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_lattice_q15.c"
...
#line 531 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_lattice_q15.c"
