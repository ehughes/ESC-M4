...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_dot_prod_q7.c"
  ...
  q31_t * result)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    input1 = *(*(int32_t __packed * *) & (pSrcA))++;
     
    input2 = *(*(int32_t __packed * *) & (pSrcB))++;
...
#line 151 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_dot_prod_q7.c"
