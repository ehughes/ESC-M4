...
#line 43 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"
  ...
  uint16_t twidCoefModifier)
{
  ...
  for (i = 0; i < n2; i++)
  {
    coeff = (*(int32_t __packed *) (pCoef + (ia * 2u)));

    ia = ia + twidCoefModifier;

    l = i + n2;

    T = (*(int32_t __packed *) (pSrc + (2 * i)));
    in = ((int16_t) (T & 0xFFFF)) >> 1;
    T = ((T >> 1) & 0xFFFF0000) | (in & 0xFFFF);

    S = (*(int32_t __packed *) (pSrc + (2 * l)));
    in = ((int16_t) (S & 0xFFFF)) >> 1;
    S = ((S >> 1) & 0xFFFF0000) | (in & 0xFFFF);

    R = __qsub16(T, S);

    (*(int32_t __packed *) (pSrc + (2 * i))) = __shadd16(T, S);
...
#line 156 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"

    (*(int32_t __packed *) (pSrc + (2u * l))) =
...
#line 191 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"
...
#line 237 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"
...
#line 264 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"
  ...
  for (i = 0; i < fftLen; i += n1)
  {
    ...
    (*(int32_t __packed *) (pSrc + (2 * i))) = __qadd16(T, S);

    (*(int32_t __packed *) (pSrc + (2u * l))) = R;
...
#line 428 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"
...
#line 484 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"
    ...
    out1 = __smusd(coeff, R) >> 16;
    out2 = __smuadx(coeff, R);
#line 518 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"
...
#line 564 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"
        ...
        out1 = __smusd(coeff, R) >> 16;
        out2 = __smuadx(coeff, R);
#line 590 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"
...
#line 741 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\TransformFunctions\\arm_cfft_radix2_q15.c"
