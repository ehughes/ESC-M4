...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_decimate_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    while(tapCnt > 0u)
    {
      ...
      x0 = *(*(int32_t __packed * *) & (px0))++;

      x1 = *(*(int32_t __packed * *) & (px1))++;
...
#line 591 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_decimate_q15.c"

#line 692 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_decimate_q15.c"
