...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_fast_q15.c"
  ...
  q15_t * pDst)
{
  ...
  while(blockSize1 > 0u)
  {
    ...
    while(k > 0u)
    {
      ...
      sum = __smladx(*(*(int32_t __packed * *) & (px))++, *(*(int32_t __packed * *) & (py))--, sum);
  ...
  if(srcBLen >= 4u)
  {
    ...
    while(blkCnt > 0u)
    {
      ...
      *(*(int32_t __packed * *) & (pOut))++ = ( ((((uint32_t)((acc0 >> 15))) ) & 0x0000FFFFUL) | ((((uint32_t)((acc1 >> 15))) << (16)) & 0xFFFF0000UL) );
      *(*(int32_t __packed * *) & (pOut))++ = ( ((((uint32_t)((acc2 >> 15))) ) & 0x0000FFFFUL) | ((((uint32_t)((acc3 >> 15))) << (16)) & 0xFFFF0000UL) );

#line 462 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_fast_q15.c"
...
#line 1406 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_conv_fast_q15.c"
}
