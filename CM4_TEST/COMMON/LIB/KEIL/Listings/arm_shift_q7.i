...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_shift_q7.c"
  ...
  uint32_t blockSize)
{
  ...
  if(sign == 0u)
  {
    ...
    while(blkCnt > 0u)
    {
      ...
      *(*(int32_t __packed * *) & (pDst))++ = ( (((int32_t)(__ssat((in1 << shiftBits), 8)) << 0) & (int32_t)0x000000FF) | (((int32_t)(__ssat((in2 << shiftBits), 8)) << 8) & (int32_t)0x0000FF00) | (((int32_t)(__ssat((in3 << shiftBits), 8)) << 16) & (int32_t)0x00FF0000) | (((int32_t)(__ssat((in4 << shiftBits), 8)) << 24) & (int32_t)0xFF000000) );
  ...
  else
  {
    ...
    while(blkCnt > 0u)
    {
      ...
      *(*(int32_t __packed * *) & (pDst))++ = ( (((int32_t)((in1 >> shiftBits)) << 0) & (int32_t)0x000000FF) | (((int32_t)((in2 >> shiftBits)) << 8) & (int32_t)0x0000FF00) | (((int32_t)((in3 >> shiftBits)) << 16) & (int32_t)0x00FF0000) | (((int32_t)((in4 >> shiftBits)) << 24) & (int32_t)0xFF000000) );
...
#line 216 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_shift_q7.c"
}
