...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_abs_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    *simd++ =
      ( ((((uint32_t)(((in1 > 0) ? in1 : (q15_t)__qsub16(0, in1)))) ) & 0x0000FFFFUL) | ((((uint32_t)(((in2 > 0) ? in2 : (q15_t)__qsub16(0, in2)))) << (16)) & 0xFFFF0000UL) );


#line 109 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_abs_q15.c"
...
#line 128 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_abs_q15.c"
...
#line 174 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_abs_q15.c"
