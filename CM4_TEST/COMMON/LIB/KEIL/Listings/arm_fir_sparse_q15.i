...
#line 41 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_sparse_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pOut))++ =
      ( ((((uint32_t)((q15_t) __ssat(in1 >> 15, 16))) ) & 0x0000FFFFUL) | ((((uint32_t)((q15_t) __ssat(in2 >> 15, 16))) << (16)) & 0xFFFF0000UL) );


#line 301 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_sparse_q15.c"
...
#line 319 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_sparse_q15.c"
...
#line 476 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_sparse_q15.c"
