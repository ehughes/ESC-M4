...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ComplexMathFunctions\\arm_cmplx_conj_q15.c"
  ...
  uint32_t numSamples)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    in1 = *(*(int32_t __packed * *) & (pSrc))++;
    in2 = *(*(int32_t __packed * *) & (pSrc))++;
    in3 = *(*(int32_t __packed * *) & (pSrc))++;
    in4 = *(*(int32_t __packed * *) & (pSrc))++;
...
#line 107 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ComplexMathFunctions\\arm_cmplx_conj_q15.c"
    ...
    *(*(int32_t __packed * *) & (pDst))++ = in1;
    *(*(int32_t __packed * *) & (pDst))++ = in2;
    *(*(int32_t __packed * *) & (pDst))++ = in3;
    *(*(int32_t __packed * *) & (pDst))++ = in4;
...
#line 156 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\ComplexMathFunctions\\arm_cmplx_conj_q15.c"
