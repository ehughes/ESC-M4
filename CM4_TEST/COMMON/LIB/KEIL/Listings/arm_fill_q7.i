...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_fill_q7.c"
  ...
  uint32_t blockSize)
{
  ...
  packedValue = ( (((int32_t)(value) << 0) & (int32_t)0x000000FF) | (((int32_t)(value) << 8) & (int32_t)0x0000FF00) | (((int32_t)(value) << 16) & (int32_t)0x00FF0000) | (((int32_t)(value) << 24) & (int32_t)0xFF000000) );
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pDst))++ = packedValue;
...
#line 104 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\SupportFunctions\\arm_fill_q7.c"
