...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_correlate_q15.c"
  ...
  q15_t * pDst)
{
  ...
  while(blockSize1 > 0u)
  {
    ...
    while(k > 0u)
    {
      ...
      sum = __smlald(*(*(int32_t __packed * *) & (px))++, *(*(int32_t __packed * *) & (py))++, sum);
...
#line 714 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_correlate_q15.c"
