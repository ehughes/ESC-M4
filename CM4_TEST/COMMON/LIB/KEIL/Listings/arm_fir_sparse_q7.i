...
#line 41 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_sparse_q7.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pOut))++ = ( (((int32_t)(in1) << 0) & (int32_t)0x000000FF) | (((int32_t)(in2) << 8) & (int32_t)0x0000FF00) | (((int32_t)(in3) << 16) & (int32_t)0x00FF0000) | (((int32_t)(in4) << 24) & (int32_t)0xFF000000) );
...
#line 475 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_sparse_q7.c"
