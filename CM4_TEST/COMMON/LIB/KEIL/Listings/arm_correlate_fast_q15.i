...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_correlate_fast_q15.c"
  ...
  q15_t * pDst)
{
  ...
  while(blockSize1 > 0u)
  {
    ...
    while(k > 0u)
    {
      ...
      sum = __smlad(*(*(int32_t __packed * *) & (px))++, *(*(int32_t __packed * *) & (py))++, sum);
...
#line 1314 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_correlate_fast_q15.c"
