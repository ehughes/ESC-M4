...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_scale_q15.c"
...
#line 98 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_scale_q15.c"
  {
    ...
    while(blkCnt > 0u)
    {
      ...
      inA1 = (*(int32_t __packed *) (pIn));
      inA2 = (*(int32_t __packed *) (pIn + 2));
      ...
      out1 = out1 >> totShift;
      inA1 = (*(int32_t __packed *) (pIn + 4));
      out2 = out2 >> totShift;
      inA2 = (*(int32_t __packed *) (pIn + 6));
      out3 = out3 >> totShift;
      out4 = out4 >> totShift;
      ...
      (*(int32_t __packed *) (pOut)) = ( ((((uint32_t)(in2)) ) & 0x0000FFFFUL) | ((((uint32_t)(in1)) << (16)) & 0xFFFF0000UL) );
      (*(int32_t __packed *) (pOut + 2)) = ( ((((uint32_t)(in4)) ) & 0x0000FFFFUL) | ((((uint32_t)(in3)) << (16)) & 0xFFFF0000UL) );
...
#line 162 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_scale_q15.c"
