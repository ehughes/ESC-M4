...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_dot_prod_q15.c"
  ...
  q63_t * result)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    sum = __smlald(*(*(int32_t __packed * *) & (pSrcA))++, *(*(int32_t __packed * *) & (pSrcB))++, sum);
    sum = __smlald(*(*(int32_t __packed * *) & (pSrcA))++, *(*(int32_t __packed * *) & (pSrcB))++, sum);
...
#line 132 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_dot_prod_q15.c"
