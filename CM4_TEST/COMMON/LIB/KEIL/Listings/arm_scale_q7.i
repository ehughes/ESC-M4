...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_scale_q7.c"
  ...
  uint32_t blockSize)
{
  ...
  q7_t in1, in2, in3, in4, out1, out2, out3, out4;       
  ...
  while(blkCnt > 0u)
  {
    ...
    *(*(int32_t __packed * *) & (pDst))++ = ( (((int32_t)(out1) << 0) & (int32_t)0x000000FF) | (((int32_t)(out2) << 8) & (int32_t)0x0000FF00) | (((int32_t)(out3) << 16) & (int32_t)0x00FF0000) | (((int32_t)(out4) << 24) & (int32_t)0xFF000000) );
...
#line 144 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_scale_q7.c"
