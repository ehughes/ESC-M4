...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_scale_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  while(blkCnt > 0u)
  {
    ...
    inA1 = *(*(int32_t __packed * *) & (pSrc))++;
    inA2 = *(*(int32_t __packed * *) & (pSrc))++;
    ...
    *(*(int32_t __packed * *) & (pDst))++ = ( ((((uint32_t)(in2)) ) & 0x0000FFFFUL) | ((((uint32_t)(in1)) << (16)) & 0xFFFF0000UL) );
    *(*(int32_t __packed * *) & (pDst))++ = ( ((((uint32_t)(in4)) ) & 0x0000FFFFUL) | ((((uint32_t)(in3)) << (16)) & 0xFFFF0000UL) );
...
#line 157 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\BasicMathFunctions\\arm_scale_q15.c"
