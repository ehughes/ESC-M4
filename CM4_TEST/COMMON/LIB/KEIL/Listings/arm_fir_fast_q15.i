...
#line 42 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_fast_q15.c"
  ...
  while(blkCnt > 0u)
  {
    ...
    *pStateCurnt++ = *pSrc++;
    ...
    while(tapCnt > 0)
    {
      ...
      x1 = ( ((((uint32_t)(x2)) ) & 0x0000FFFFUL) | ((((uint32_t)(x0)) << (0)) & 0xFFFF0000UL) );
      ...
      x1 = ( ((((uint32_t)(x0)) ) & 0x0000FFFFUL) | ((((uint32_t)(x2)) << (0)) & 0xFFFF0000UL) );
...
#line 262 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_fir_fast_q15.c"
