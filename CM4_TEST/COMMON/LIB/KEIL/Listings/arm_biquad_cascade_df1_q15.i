...
#line 43 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_biquad_cascade_df1_q15.c"
  ...
  uint32_t blockSize)
{
  ...
  do
  {
    ...
    b0 = *(*(int32_t __packed * *) & (pCoeffs))++;

     
    b1 = *(*(int32_t __packed * *) & (pCoeffs))++;

     
    a1 = *(*(int32_t __packed * *) & (pCoeffs))++;

     
    state_in = *(*(int32_t __packed * *) & (pState))++;

     
    state_out = *(*(int32_t __packed * *) & (pState))--;
...
#line 175 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_biquad_cascade_df1_q15.c"
      ...
      *(*(int32_t __packed * *) & (pOut))++ = ( ((((uint32_t)(state_out)) ) & 0x0000FFFFUL) | ((((uint32_t)(out)) << (16)) & 0xFFFF0000UL) );
...
#line 226 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_biquad_cascade_df1_q15.c"
...
#line 293 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_biquad_cascade_df1_q15.c"
    ...
    *(*(int32_t __packed * *) & (pState))++ = state_in;
    *(*(int32_t __packed * *) & (pState))++ = state_out;
...
#line 405 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\FilteringFunctions\\arm_biquad_cascade_df1_q15.c"
