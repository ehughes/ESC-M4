...
#line 41 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_cmplx_mult_q15.c"
...
#line 126 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_cmplx_mult_q15.c"
  {
    ...
    do
    {
      ...
      while(col > 0u)
      {
#line 193 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_cmplx_mult_q15.c"

         
        in = *(*(int32_t __packed * *) & (pInB))++;

        *(*(int32_t __packed * *) & (px)) = in;
...
#line 325 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_cmplx_mult_q15.c"
           
          pSourceA = *(*(int32_t __packed * *) & (pInA))++;
          pSourceB = *(*(int32_t __packed * *) & (pInB))++;
...
#line 379 "..\\..\\SRC\\CMSIS_DSP_4_5\\src\\MatrixFunctions\\arm_mat_cmplx_mult_q15.c"
